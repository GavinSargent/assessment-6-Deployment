...
const drawFive = () => {
    axios.get('http://54.215.63.23/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://54.215.63.23/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://54.215.63.23/api/player')
...
const getAllBots = () => {
    axios.get('http://54.215.63.23/api/robots')
        .then(({data}) => {
